...
\title{Monitoring and understanding the Urban Heat Island: comparison of observations and models in Baltimore, Maryland}
...
Heat exposure is one of the deadliest forms of climate hazards \citep{wmo}, killing an average of 130 people annually in the United States \citep{usnh_stat}; in resource-poor settings, the health and economic impact from heat is even higher \citep{wmo}. This burden is expected to worsen in future years as rising global temperatures raise the public health and economic consequences of heat exposure \citep{ipcc}. 
...
Our study uses observations and models to answer several questions about the urban heat island. 
