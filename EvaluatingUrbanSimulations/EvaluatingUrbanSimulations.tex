...
This paper uses the Weather, Research, and Forecasting Model (WRF) vx.x with the urban canopy model in \cite{chen2011integrated}. [Get Hamada to help fill in here. ]
...
We evaluate the simulated 2-meter temperature against the observation in the nearest grid box using several statistical methods. First, the root-mean squared error $RMSE$:  
