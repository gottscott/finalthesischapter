...
Figure~\ref{fig:hist}b) shows histograms of spatially averaged temperatures at each site grouped by land types. In all cases, temperature variability is low 
% note: calcluate this 


\subsubsection{Diurnal}
 First, we examine the diurnal variability by land use in Fig.~\ref{fig:diurnal}c. At all sites, modeled temperature reaches its minimum at 6am and acheives maximum temperature around noon, cooling slightly until X pm,
% values here 
